...
#ifndef VERILATED_VMEM_STAGE_PIP_H_
#define VERILATED_VMEM_STAGE_PIP_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vmem_stage_pip VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vmem_stage_pip___024root* const rootp;
    ...
    explicit Vmem_stage_pip(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vmem_stage_pip(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vmem_stage_pip();
  private:
    VL_UNCOPYABLE(Vmem_stage_pip);  ///< Copying not allowed
