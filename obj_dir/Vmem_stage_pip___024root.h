...
#ifndef VERILATED_VMEM_STAGE_PIP___024ROOT_H_
#define VERILATED_VMEM_STAGE_PIP___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vmem_stage_pip___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ mem_stage_pip__DOT__wb_sel_in;
        ...
        CData/*1:0*/ mem_stage_pip__DOT__wb_sel_out;
        ...
        CData/*1:0*/ mem_stage_pip__DOT__memwb_register__DOT__wb_sel_in;
        CData/*4:0*/ mem_stage_pip__DOT__memwb_register__DOT__rd_in;
        CData/*4:0*/ mem_stage_pip__DOT__memwb_register__DOT__rd_out;
        CData/*1:0*/ mem_stage_pip__DOT__memwb_register__DOT__wb_sel_out;
    ...
    struct {
        ...
        IData/*31:0*/ mem_stage_pip__DOT__memwb_register__DOT__pc_in;
        ...
        IData/*31:0*/ mem_stage_pip__DOT__memwb_register__DOT__pc_out;
    ...
    // INTERNAL VARIABLES
    Vmem_stage_pip__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vmem_stage_pip___024root(Vmem_stage_pip__Syms* symsp, const char* v__name);
    ~Vmem_stage_pip___024root();
    VL_UNCOPYABLE(Vmem_stage_pip___024root);
