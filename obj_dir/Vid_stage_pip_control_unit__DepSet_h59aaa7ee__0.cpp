...
VL_INLINE_OPT void Vid_stage_pip_control_unit___ico_sequent__TOP__id_stage_pip__control__0(Vid_stage_pip_control_unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vid_stage_pip_control_unit___ico_sequent__TOP__id_stage_pip__control__0\n"); );
