...
VL_ATTR_COLD void Vmem_stage_pip___024root___eval_static(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vmem_stage_pip___024root___eval_initial(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_initial\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vmem_stage_pip___024root___eval_final(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_final\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__stl(Vmem_stage_pip___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vmem_stage_pip___024root___eval_phase__stl(Vmem_stage_pip___024root* vlSelf);

VL_ATTR_COLD void Vmem_stage_pip___024root___eval_settle(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_settle\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vmem_stage_pip___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("rtl/mem_stage_pip.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vmem_stage_pip___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__stl(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___dump_triggers__stl\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmem_stage_pip___024root___eval_stl(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_stl\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vmem_stage_pip___024root___eval_triggers__stl(Vmem_stage_pip___024root* vlSelf);

VL_ATTR_COLD bool Vmem_stage_pip___024root___eval_phase__stl(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_phase__stl\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vmem_stage_pip___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vmem_stage_pip___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__ico(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___dump_triggers__ico\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__act(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___dump_triggers__act\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__nba(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___dump_triggers__nba\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmem_stage_pip___024root___ctor_var_reset(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___ctor_var_reset\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->wb_sel_in = VL_RAND_RESET_I(2);
    ...
    vlSelf->mem_stage_pip__DOT__pc_in = VL_RAND_RESET_I(32);
    ...
    vlSelf->mem_stage_pip__DOT__wb_sel_in = VL_RAND_RESET_I(2);
    ...
    vlSelf->mem_stage_pip__DOT__pc_out = VL_RAND_RESET_I(32);
    ...
    vlSelf->mem_stage_pip__DOT__wb_sel_out = VL_RAND_RESET_I(2);
    ...
    vlSelf->mem_stage_pip__DOT__memwb_register__DOT__wb_sel_in = VL_RAND_RESET_I(2);
    vlSelf->mem_stage_pip__DOT__memwb_register__DOT__pc_in = VL_RAND_RESET_I(32);
    ...
    vlSelf->mem_stage_pip__DOT__memwb_register__DOT__pc_out = VL_RAND_RESET_I(32);
    ...
    vlSelf->mem_stage_pip__DOT__memwb_register__DOT__wb_sel_out = VL_RAND_RESET_I(2);
