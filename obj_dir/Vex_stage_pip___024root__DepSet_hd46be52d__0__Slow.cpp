...
VL_ATTR_COLD void Vex_stage_pip___024root___ctor_var_reset(Vex_stage_pip___024root* vlSelf) {
    ...
    vlSelf->alu_a_debug = VL_RAND_RESET_I(32);
    vlSelf->alu_b_debug = VL_RAND_RESET_I(32);
    vlSelf->alu_ctrl_debug = VL_RAND_RESET_I(4);
    ...
    vlSelf->ex_stage_pip__DOT__funct3_in = VL_RAND_RESET_I(3);
    ...
    vlSelf->ex_stage_pip__DOT__wb_sel_in = VL_RAND_RESET_I(2);
    ...
    vlSelf->ex_stage_pip__DOT__funct3_out = VL_RAND_RESET_I(3);
    ...
    vlSelf->ex_stage_pip__DOT__wb_sel_out = VL_RAND_RESET_I(2);
    ...
    vlSelf->ex_stage_pip__DOT__alu_a_debug = VL_RAND_RESET_I(32);
    vlSelf->ex_stage_pip__DOT__alu_b_debug = VL_RAND_RESET_I(32);
    vlSelf->ex_stage_pip__DOT__alu_ctrl_debug = VL_RAND_RESET_I(4);
    ...
    vlSelf->ex_stage_pip__DOT__exmem_register__DOT__funct3_in = VL_RAND_RESET_I(3);
    ...
    vlSelf->ex_stage_pip__DOT__exmem_register__DOT__wb_sel_in = VL_RAND_RESET_I(2);
    ...
    vlSelf->ex_stage_pip__DOT__exmem_register__DOT__funct3_out = VL_RAND_RESET_I(3);
    ...
    vlSelf->ex_stage_pip__DOT__exmem_register__DOT__wb_sel_out = VL_RAND_RESET_I(2);
