    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_id_stage_pip__reg_file.varInsert(__Vfinal,"register_", &(TOP.id_stage_pip__DOT__reg_file__DOT__register_), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1,1 ,1,31 ,31,0);
