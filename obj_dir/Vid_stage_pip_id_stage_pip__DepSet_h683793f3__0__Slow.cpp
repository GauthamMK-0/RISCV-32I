...
VL_ATTR_COLD void Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__0(Vid_stage_pip_id_stage_pip* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__0\n"); );
...
VL_ATTR_COLD void Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__1(Vid_stage_pip_id_stage_pip* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__1\n"); );
    Vid_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__2(Vid_stage_pip_id_stage_pip* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vid_stage_pip_id_stage_pip___stl_sequent__TOP__id_stage_pip__2\n"); );
    Vid_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
