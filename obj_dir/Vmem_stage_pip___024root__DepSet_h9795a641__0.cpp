...
void Vmem_stage_pip___024root___ico_sequent__TOP__0(Vmem_stage_pip___024root* vlSelf);

void Vmem_stage_pip___024root___eval_ico(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_ico\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VicoTriggered.word(0U))) {
        Vmem_stage_pip___024root___ico_sequent__TOP__0(vlSelf);
    }
}

extern const VlUnpacked<CData/*3:0*/, 32> Vmem_stage_pip__ConstPool__TABLE_hfaa174bc_0;

VL_INLINE_OPT void Vmem_stage_pip___024root___ico_sequent__TOP__0(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___ico_sequent__TOP__0\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    vlSelfRef.mem_stage_pip__DOT__byte_mask__DOT__byte_enable 
        = Vmem_stage_pip__ConstPool__TABLE_hfaa174bc_0
        [__Vtableidx1];
...
void Vmem_stage_pip___024root___eval_triggers__ico(Vmem_stage_pip___024root* vlSelf);

bool Vmem_stage_pip___024root___eval_phase__ico(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_phase__ico\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vmem_stage_pip___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelfRef.__VicoTriggered.any();
    if (__VicoExecute) {
        Vmem_stage_pip___024root___eval_ico(vlSelf);
    }
    return (__VicoExecute);
}

void Vmem_stage_pip___024root___eval_act(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_act\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

void Vmem_stage_pip___024root___nba_sequent__TOP__0(Vmem_stage_pip___024root* vlSelf);
void Vmem_stage_pip___024root___nba_sequent__TOP__1(Vmem_stage_pip___024root* vlSelf);
void Vmem_stage_pip___024root___nba_sequent__TOP__2(Vmem_stage_pip___024root* vlSelf);

void Vmem_stage_pip___024root___eval_nba(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_nba\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vmem_stage_pip___024root___nba_sequent__TOP__0(vlSelf);
    }
    if ((3ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vmem_stage_pip___024root___nba_sequent__TOP__1(vlSelf);
    }
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vmem_stage_pip___024root___nba_sequent__TOP__2(vlSelf);
    }
}

VL_INLINE_OPT void Vmem_stage_pip___024root___nba_sequent__TOP__0(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___nba_sequent__TOP__0\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_INLINE_OPT void Vmem_stage_pip___024root___nba_sequent__TOP__1(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___nba_sequent__TOP__1\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vmem_stage_pip___024root___nba_sequent__TOP__2(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___nba_sequent__TOP__2\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.mem_stage_pip__DOT__mem_data = vlSelfRef.mem_stage_pip__DOT__mem_access__DOT__mem_out;
...
void Vmem_stage_pip___024root___eval_triggers__act(Vmem_stage_pip___024root* vlSelf);

bool Vmem_stage_pip___024root___eval_phase__act(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_phase__act\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    // Body
    Vmem_stage_pip___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelfRef.__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelfRef.__VactTriggered, vlSelfRef.__VnbaTriggered);
        vlSelfRef.__VnbaTriggered.thisOr(vlSelfRef.__VactTriggered);
        Vmem_stage_pip___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool Vmem_stage_pip___024root___eval_phase__nba(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_phase__nba\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if (__VnbaExecute) {
        Vmem_stage_pip___024root___eval_nba(vlSelf);
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__ico(Vmem_stage_pip___024root* vlSelf);
#endif  // VL_DEBUG
#ifdef VL_DEBUG
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__nba(Vmem_stage_pip___024root* vlSelf);
#endif  // VL_DEBUG
#ifdef VL_DEBUG
VL_ATTR_COLD void Vmem_stage_pip___024root___dump_triggers__act(Vmem_stage_pip___024root* vlSelf);
#endif  // VL_DEBUG

void Vmem_stage_pip___024root___eval(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vmem_stage_pip___024root___dump_triggers__ico(vlSelf);
#endif
            VL_FATAL_MT("rtl/mem_stage_pip.v", 1, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vmem_stage_pip___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
    ...
    while (__VnbaContinue) {
...
#ifdef VL_DEBUG
            Vmem_stage_pip___024root___dump_triggers__nba(vlSelf);
#endif
        ...
        while (vlSelfRef.__VactContinue) {
...
#ifdef VL_DEBUG
                Vmem_stage_pip___024root___dump_triggers__act(vlSelf);
#endif
            ...
            if (Vmem_stage_pip___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vmem_stage_pip___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vmem_stage_pip___024root___eval_debug_assertions(Vmem_stage_pip___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem_stage_pip___024root___eval_debug_assertions\n"); );
    Vmem_stage_pip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
