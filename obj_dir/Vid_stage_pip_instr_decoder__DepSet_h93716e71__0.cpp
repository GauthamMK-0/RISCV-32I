...
VL_INLINE_OPT void Vid_stage_pip_instr_decoder___ico_sequent__TOP__id_stage_pip__decoder__0(Vid_stage_pip_instr_decoder* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vid_stage_pip_instr_decoder___ico_sequent__TOP__id_stage_pip__decoder__0\n"); );
